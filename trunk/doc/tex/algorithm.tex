...
Jest to pamiêæ w postaci tablicy w której zapisujemy przestawienia w danym otoczeniu. (lista tabu) Warto¶ci na li¶cie maj± okre¶lony czas wa¿no¶ci\footnote{wyra¿ony w liczbie iteracji}.

\item[Pamiêæ d³ugoterminowa] (oznaczana dalej jako DLT)
Podobnie jak pamiêæ krótkoterminowa s³u¿y do zliczania przestawieñ elementów, z t± ró¿nic±, ¿e zapamiêtuje wszystkie przestawienia - lista nie jest wymazywana.
\end{description}
\subsection{Algorytm}
\begin{itemize}
